...
WEB_SERVICE_NAME="${WEB_SERVICE_NAME:-traxettle-web-prod}"
HOSTING_SITE_ID="${HOSTING_SITE_ID:-CHANGE_ME_PROD_FIREBASE_HOSTING_SITE_ID}"

# Public client-side env (used at build-time and runtime)
NEXT_PUBLIC_API_URL="${NEXT_PUBLIC_API_URL:-CHANGE_ME_PROD_API_URL}"
NEXT_PUBLIC_APP_ENV="${NEXT_PUBLIC_APP_ENV:-production}"
NEXT_PUBLIC_FIREBASE_API_KEY="${NEXT_PUBLIC_FIREBASE_API_KEY:-CHANGE_ME_PROD_FIREBASE_WEB_API_KEY}"
NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN="${NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN:-CHANGE_ME_PROD_FIREBASE_AUTH_DOMAIN}"
NEXT_PUBLIC_FIREBASE_PROJECT_ID="${NEXT_PUBLIC_FIREBASE_PROJECT_ID:-CHANGE_ME_PROD_FIREBASE_PROJECT_ID}"
NEXT_PUBLIC_FIREBASE_STORAGE_BUCKET="${NEXT_PUBLIC_FIREBASE_STORAGE_BUCKET:-CHANGE_ME_PROD_FIREBASE_STORAGE_BUCKET}"
NEXT_PUBLIC_FIREBASE_MESSAGING_SENDER_ID="${NEXT_PUBLIC_FIREBASE_MESSAGING_SENDER_ID:-CHANGE_ME_PROD_MESSAGING_SENDER_ID}"
NEXT_PUBLIC_FIREBASE_APP_ID="${NEXT_PUBLIC_FIREBASE_APP_ID:-CHANGE_ME_PROD_WEB_APP_ID}"
...
# Optional config file (created by scripts/web-deployment/configure-prod.sh)
CONFIG_FILE="${REPO_ROOT}/.traxettle/web-prod.env"
