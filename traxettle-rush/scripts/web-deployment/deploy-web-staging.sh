...
REGION="us-central1"
WEB_SERVICE_NAME="traxettle-web-staging"
HOSTING_SITE_ID="traxettle-staging"
...
NEXT_PUBLIC_FIREBASE_API_KEY="AIzaSyBEySHT0NTDjdXiA6qf70K76pcGSa8knVk"
NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN="traxettle-staging.firebaseapp.com"
NEXT_PUBLIC_FIREBASE_PROJECT_ID="traxettle-staging"
NEXT_PUBLIC_FIREBASE_STORAGE_BUCKET="traxettle-staging.firebasestorage.app"
NEXT_PUBLIC_FIREBASE_MESSAGING_SENDER_ID="943648574702"
NEXT_PUBLIC_FIREBASE_APP_ID="1:943648574702:web:dadc768deff3146f3b77ff"
NEXT_PUBLIC_FIREBASE_MEASUREMENT_ID="G-3N2XT1HV18"

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
REPO_ROOT="$(cd "${SCRIPT_DIR}/../../../traxettle-rush" && pwd)"
BUILD_SOURCE_DIR="$(mktemp -d)"
TMP_CONFIG="$REPO_ROOT/.firebase-hosting-staging.generated.json"
...
echo ""
echo "Web staging deploy complete"
