...
echo "  - WEB deploy uses .traxettle/web-prod.env from scripts/web-deployment/configure-prod.sh"
echo ""
echo "Note:"
...
EOF
    ...
    echo ""
    echo "Reminder:"
    echo "  SMTP_PASS must be a Gmail App Password, not your normal Gmail password."
    echo ""
