...
ENV_VARS="NODE_ENV=${NODE_ENV_VALUE},APP_URL=${APP_URL},REVENUECAT_PRO_ENTITLEMENT_ID=${REVENUECAT_PRO_ENTITLEMENT_ID:-pro},REVENUECAT_OFFERING_ID=${REVENUECAT_OFFERING_ID:-${RC_REVENUECAT_OFFERING_ID:-default}}"
