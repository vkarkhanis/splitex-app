export type TraxettleThemeName = 'light' | 'dark' | 'ocean' | 'forest' | 'midnight';

export type TraxettleTheme = {
  name: TraxettleThemeName;
  colors: {
    primary: string;
    primaryHover: string;
    secondary: string;
...
export const themes: Record<TraxettleThemeName, TraxettleTheme> = {
  light: {
    name: 'light',
    colors: {
      primary: '#3b82f6',
