...
export const webSteps: WorkflowStep[] = [
  ...
  // ────────────────────────────────────────────────────────────────────────────
  {
    ...
    instructions: [
      ...
      '- Google Play / App Store subscription purchase is separate from settlement gateways.',
      '- Traxettle settlement defaults to manual/external payment unless you explicitly enable the settlement gateway pilot.',
      '- Optional pilot flag: SETTLEMENT_GATEWAY_PILOT_ENABLED=true',
  ...
  },
  {
    ...
    instructions: [
      ...
      'Settlement gateways:',
      '- Default / recommended current behavior: leave SETTLEMENT_GATEWAY_PILOT_ENABLED unset or false',
      '- That keeps the original manual settlement modal and hides Razorpay/BillDesk options',
      '- Enable the flag only for explicit pilot testing',
  ...
  // ────────────────────────────────────────────────────────────────────────────
  {
    ...
    instructions: [
      ...
      '- Settlement gateways remain pilot-only:',
      '  • leave SETTLEMENT_GATEWAY_PILOT_ENABLED=false unless you are intentionally testing gateway settlement',
      '  • the default product behavior is still manual/external settlement',
    ],
    scripts: [
  ...
  },
  {
    ...
    instructions: [
      ...
      'Settlement gateway note:',
      '- Keep SETTLEMENT_GATEWAY_PILOT_ENABLED unset/false for normal production deploys',
      '- That preserves the legacy manual settlement UX and hides Razorpay/BillDesk settlement buttons',
    ],
