...
function printJwtSecretGuidance() {
  colorLog('yellow', 'JWT secrets are generated by you; they do not come from Firebase/GCP.');
  colorLog('cyan', 'Generate them with:');
  console.log(
  ...
  colorLog('cyan', 'Paste the results into configure-staging.sh / configure-prod.sh when prompted.');
}
...
class TraxettleDoctor {
  ...
  async checkEnvironmentVariables() {
    ...
    if ((this.environment === 'staging' || this.environment === 'production')
      ...
      printJwtSecretGuidance();
      this.warnings.push('JWT secrets must be generated and supplied for deployed API environments');
    }
