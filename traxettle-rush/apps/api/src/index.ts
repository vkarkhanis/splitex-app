...
const MOBILE_DEEP_LINK_SCHEME = process.env.MOBILE_DEEP_LINK_SCHEME || 'com.traxettle.app';

// Middleware
app.use(helmet());
app.use(cors());
// Payment proof uploads send base64 payloads; default 100kb is too small.
...
<html lang="en">
  ...
  <body>
    <div class="wrap">
      <div class="card">
        <h1>Open Traxettle</h1>
        <p>Tap below to continue sign-in in the Traxettle app.</p>
        <a class="btn" href="${escapedDeepLink}">Open Traxettle App</a>
...
server.listen(Number(PORT), '0.0.0.0', () => {
  console.log(`🚀 Traxettle API server running on 0.0.0.0:${PORT}`);
});
