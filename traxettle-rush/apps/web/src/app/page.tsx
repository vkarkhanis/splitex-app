...
export default function Home() {
  ...
  useEffect(() => {
    const check = () => setIsAuthenticated(Boolean(window.localStorage.getItem('traxettle.authToken')));
    check();
    window.addEventListener('traxettle:authChange', check);
    window.addEventListener('storage', check);
    return () => {
      window.removeEventListener('traxettle:authChange', check);
