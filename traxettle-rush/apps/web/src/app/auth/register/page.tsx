...
export default function RegisterPage() {
  ...
  const handleGoogleSignUp = async () => {
    ...
    try {
      ...
      push({
        ...
        message: `Welcome to Traxettle, ${result.user.displayName || result.user.email}!`
      });
  ...
  const handleEmailSignUp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      localStorage.setItem('traxettle.authToken', idToken);
      localStorage.setItem('traxettle.uid', credential.user.uid);
      window.dispatchEvent(new Event('traxettle:authChange'));

      push({
        type: 'success',
        title: 'Account Created',
        message: 'Welcome to Traxettle! Complete your profile.'
      });
      ...
      <Stack>
        <Card>
          <CardHeader>
            ...
            <CardSubtitle>Join Traxettle to start splitting expenses</CardSubtitle>
          </CardHeader>
