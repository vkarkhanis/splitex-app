...
React + Next.js web frontend for Traxettle. This guide mirrors the mobile README structure but is tailored for web setup, testing, settlements, and internal validation.
...
7. [Testing Traxettle](#testing-traxettle)
...
Run from monorepo root (`traxettle-rush/`):
...
Backend mode flags (set in `/Users/vkarkhanis/workspace/Traxettle/traxettle-rush/.env.local`):
...
- Framework: Playwright (`/Users/vkarkhanis/workspace/Traxettle/traxettle-rush/e2e`)
