# Traxettle Mobile App — Developer Guide

Complete React Native (Expo) mobile application for iOS and Android. This guide covers everything you need to set up, run, test, and debug the Traxettle mobile app on simulators, emulators, and real devices.
...
10. [Testing Traxettle](#testing-traxettle)
...
From the **monorepo root** (`traxettle-rush/`):
...
```typescript
// Default: connects to localhost:3001 in dev, api.traxettle.app in prod
export const ENV = {
  API_URL: __DEV__ ? 'http://localhost:3001' : 'https://api.traxettle.app',
  WS_URL:  __DEV__ ? 'ws://localhost:3001/ws' : 'wss://api.traxettle.app/ws',
};
```
...
|----------|---------------|-------------|
| `EXPO_PUBLIC_API_URL` | `http://localhost:3001` | Traxettle API base URL |
...
Set these in:
`/Users/vkarkhanis/workspace/Traxettle/traxettle-rush/.env.local`
...
# 2. Open in Xcode
open apps/mobile/ios/Traxettle.xcworkspace
...
2. Ensure API environment exists:
   - File: `/Users/vkarkhanis/workspace/Traxettle/traxettle-rush/.env.local`
...
3. Confirm app identifiers in:
   - `/Users/vkarkhanis/workspace/Traxettle/traxettle-rush/apps/mobile/app.json`
...
|------|--------|-----------------|
| 1 | App launches | Login screen appears with "Traxettle" branding |
...
Suite location:
- `/Users/vkarkhanis/workspace/Traxettle/traxettle-rush/apps/mobile/maestro/flows`
...
- Location: `/Users/vkarkhanis/workspace/Traxettle/traxettle-rush/apps/mobile/src/__tests__`
...
- Product E2E framework: `Playwright` in `/Users/vkarkhanis/workspace/Traxettle/traxettle-rush/e2e`
...
- Native mobile E2E framework: `Maestro` in `/Users/vkarkhanis/workspace/Traxettle/traxettle-rush/apps/mobile/maestro`
...
- Tokens stored in `AsyncStorage` under `@traxettle_token`
...
| `@traxettle/shared` module not found | Run `rush build:shared` from the monorepo root |
...
**Traxettle Mobile** — Expense splitting on the go.
