...
REGION="us-central1"
WEB_SERVICE_NAME="splitex-web-staging"
HOSTING_SITE_ID="app-splitex-staging-web"

# Public client-side env (used at build-time and runtime)
NEXT_PUBLIC_API_URL="https://splitex-api-staging-862789756309.us-central1.run.app"
NEXT_PUBLIC_APP_ENV="staging"
NEXT_PUBLIC_FIREBASE_API_KEY="AIzaSyBW2jrlsrUOYgBI7zR_A4cnLYQeC_oEew8"
NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN="app-splitex-staging.firebaseapp.com"
NEXT_PUBLIC_FIREBASE_PROJECT_ID="app-splitex-staging"
NEXT_PUBLIC_FIREBASE_STORAGE_BUCKET="app-splitex-staging.firebasestorage.app"
NEXT_PUBLIC_FIREBASE_MESSAGING_SENDER_ID="862789756309"
NEXT_PUBLIC_FIREBASE_APP_ID="1:862789756309:web:c092122a9dcfc9976dc29c"
NEXT_PUBLIC_FIREBASE_MEASUREMENT_ID="G-V6BBB2D8T3"
