...
export class EmailService {
  ...
  constructor() {
    ...
    this.fromAddress = process.env.SMTP_FROM || process.env.SMTP_USER || 'noreply@splitex.app';
  ...
  async sendInvitationEmail(data: InvitationEmailData): Promise<{ success: boolean; messageId?: string; error?: string }> {
    ...
    const subject = `You're invited to "${data.eventName}" on Splitex`;
