# Traxettle Free/Pro Production Implementation Checklist
...
Use scripts from `traxettle-rush/scripts/revenuecat`:
...
Run:
```bash
cd /Users/vkarkhanis/workspace/Traxettle/traxettle-app/features-checklist/tier_based_behaviour
