...
Primary runbook:
- `/Users/vkarkhanis/workspace/Traxettle/traxettle-app/deployment/DEPLOYMENT_RUNBOOK.md`
...
- [ ] Logged in: `eas login`
- [ ] `eas whoami` works in `/Users/vkarkhanis/workspace/Traxettle/traxettle-rush/apps/mobile`
- [ ] `eas.json` exists in `/Users/vkarkhanis/workspace/Traxettle/traxettle-rush/apps/mobile`
...
- [ ] Edit `/Users/vkarkhanis/workspace/Traxettle/traxettle-app/deployment/scripts/deploy-staging.sh`
...
- [ ] Edit `/Users/vkarkhanis/workspace/Traxettle/traxettle-app/deployment/scripts/deploy-prod.sh`
...
- [ ] `Dockerfile.web` exists at `/Users/vkarkhanis/workspace/Traxettle/traxettle-rush/Dockerfile.web`
- [ ] `StyledComponentsRegistry.tsx` is tracked in git:
  - [ ] `git -C /Users/vkarkhanis/workspace/Traxettle ls-files -- traxettle-rush/apps/web/src/lib/StyledComponentsRegistry.tsx` returns a path
- [ ] Edit `/Users/vkarkhanis/workspace/Traxettle/traxettle-app/deployment/scripts/deploy-web-staging.sh`
...
- [ ] Edit `/Users/vkarkhanis/workspace/Traxettle/traxettle-app/deployment/scripts/deploy-web-prod.sh`
...
- [ ] If script pauses after Cloud Run, run Hosting deploy directly with debug:
  - [ ] `cd /Users/vkarkhanis/workspace/Traxettle/traxettle-rush && firebase deploy --project <PROJECT_ID> --only hosting --config .firebase-hosting-<env>.generated.json --non-interactive --debug`
...
- [ ] From `/Users/vkarkhanis/workspace/Traxettle/traxettle-rush`, run:
...
- [ ] Run Maestro:
  - [ ] `cd /Users/vkarkhanis/workspace/Traxettle/traxettle-rush && rush test:maestro`
